...
exports.CommandDataSchema = zod_1.default.lazy(() => zod_1.default.union([
    ...
    exports.EmulationCommandSchema,
...
(function (Browser) {
    Browser.CreateUserContextParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        acceptInsecureCerts: zod_1.default.boolean().optional(),
        proxy: Session.ProxyConfigurationSchema.optional(),
        unhandledPromptBehavior: Session.UserPromptHandlerSchema.optional(),
    }));
...
(function (BrowsingContext) {
    BrowsingContext.BaseNavigationInfoSchema = zod_1.default.lazy(() => zod_1.default.object({
        context: BrowsingContext.BrowsingContextSchema,
...
(function (BrowsingContext) {
    BrowsingContext.NavigationInfoSchema = zod_1.default.lazy(() => BrowsingContext.BaseNavigationInfoSchema);
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
...
(function (BrowsingContext) {
    BrowsingContext.DownloadWillBeginParamsSchema = zod_1.default.lazy(() => zod_1.default
        .object({
        suggestedFilename: zod_1.default.string(),
    })
        .and(BrowsingContext.BaseNavigationInfoSchema));
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
    BrowsingContext.DownloadEndSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('browsingContext.downloadEnd'),
        params: BrowsingContext.DownloadEndParamsSchema,
    }));
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
    BrowsingContext.DownloadEndParamsSchema = zod_1.default.lazy(() => zod_1.default.union([
        BrowsingContext.DownloadCanceledParamsSchema,
        BrowsingContext.DownloadCompleteParamsSchema,
    ]));
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
    BrowsingContext.DownloadCanceledParamsSchema = zod_1.default.lazy(() => zod_1.default
        .object({
        status: zod_1.default.literal('canceled'),
    })
        .and(BrowsingContext.BaseNavigationInfoSchema));
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
    BrowsingContext.DownloadCompleteParamsSchema = zod_1.default.lazy(() => zod_1.default
        .object({
        status: zod_1.default.literal('complete'),
        filepath: zod_1.default.union([zod_1.default.string(), zod_1.default.null()]),
    })
        .and(BrowsingContext.BaseNavigationInfoSchema));
})(BrowsingContext || (exports.BrowsingContext = BrowsingContext = {}));
(function (BrowsingContext) {
...
exports.EmulationCommandSchema = zod_1.default.lazy(() => zod_1.default.union([
...
var Emulation;
(function (Emulation) {
    Emulation.SetForcedColorsModeThemeOverrideSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('emulation.setForcedColorsModeThemeOverride'),
        params: Emulation.SetForcedColorsModeThemeOverrideParametersSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetForcedColorsModeThemeOverrideParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        theme: zod_1.default.union([Emulation.ForcedColorsModeThemeSchema, zod_1.default.null()]),
        contexts: zod_1.default
            .array(BrowsingContext.BrowsingContextSchema)
            .min(1)
            .optional(),
...
(function (Emulation) {
    Emulation.ForcedColorsModeThemeSchema = zod_1.default.lazy(() => zod_1.default.enum(['light', 'dark']));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetGeolocationOverrideSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('emulation.setGeolocationOverride'),
        params: Emulation.SetGeolocationOverrideParametersSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetGeolocationOverrideParametersSchema = zod_1.default.lazy(() => zod_1.default
        .union([
        zod_1.default.object({
            coordinates: zod_1.default.union([
...
(function (Emulation) {
    Emulation.GeolocationCoordinatesSchema = zod_1.default.lazy(() => zod_1.default.object({
        latitude: zod_1.default.number().gte(-90).lte(90),
        longitude: zod_1.default.number().gte(-180).lte(180),
        accuracy: zod_1.default.number().gte(0).default(1).optional(),
        altitude: zod_1.default.union([zod_1.default.number(), zod_1.default.null().default(null)]).optional(),
        altitudeAccuracy: zod_1.default
            .union([zod_1.default.number().gte(0), zod_1.default.null().default(null)])
            .optional(),
        heading: zod_1.default
            .union([zod_1.default.number().gt(0).lt(360), zod_1.default.null().default(null)])
            .optional(),
        speed: zod_1.default.union([zod_1.default.number().gte(0), zod_1.default.null().default(null)]).optional(),
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.GeolocationPositionErrorSchema = zod_1.default.lazy(() => zod_1.default.object({
        type: zod_1.default.literal('positionUnavailable'),
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetLocaleOverrideSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('emulation.setLocaleOverride'),
        params: Emulation.SetLocaleOverrideParametersSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetLocaleOverrideParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        locale: zod_1.default.union([zod_1.default.string(), zod_1.default.null()]),
        contexts: zod_1.default
            .array(BrowsingContext.BrowsingContextSchema)
            .min(1)
            .optional(),
...
(function (Emulation) {
    Emulation.SetScreenOrientationOverrideSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('emulation.setScreenOrientationOverride'),
        params: Emulation.SetScreenOrientationOverrideParametersSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.ScreenOrientationNaturalSchema = zod_1.default.lazy(() => zod_1.default.enum(['portrait', 'landscape']));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.ScreenOrientationTypeSchema = zod_1.default.lazy(() => zod_1.default.enum([
        'portrait-primary',
        'portrait-secondary',
        'landscape-primary',
        'landscape-secondary',
...
(function (Emulation) {
    Emulation.ScreenOrientationSchema = zod_1.default.lazy(() => zod_1.default.object({
        natural: Emulation.ScreenOrientationNaturalSchema,
        type: Emulation.ScreenOrientationTypeSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetScreenOrientationOverrideParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        screenOrientation: zod_1.default.union([Emulation.ScreenOrientationSchema, zod_1.default.null()]),
        contexts: zod_1.default
            .array(BrowsingContext.BrowsingContextSchema)
            .min(1)
            .optional(),
...
(function (Emulation) {
    Emulation.SetTimezoneOverrideSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('emulation.setTimezoneOverride'),
        params: Emulation.SetTimezoneOverrideParametersSchema,
    }));
})(Emulation || (exports.Emulation = Emulation = {}));
(function (Emulation) {
    Emulation.SetTimezoneOverrideParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        timezone: zod_1.default.union([zod_1.default.string(), zod_1.default.null()]),
        contexts: zod_1.default
            .array(BrowsingContext.BrowsingContextSchema)
            .min(1)
            .optional(),
...
(function (Network) {
    Network.CollectorSchema = zod_1.default.lazy(() => zod_1.default.string());
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.CollectorTypeSchema = zod_1.default.literal('blob');
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.SameSiteSchema = zod_1.default.lazy(() => zod_1.default.enum(['strict', 'lax', 'none', 'default']));
})(Network || (exports.Network = Network = {}));
(function (Network) {
...
(function (Network) {
    Network.DataTypeSchema = zod_1.default.literal('response');
})(Network || (exports.Network = Network = {}));
(function (Network) {
...
(function (Network) {
    Network.AddDataCollectorSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('network.addDataCollector'),
        params: Network.AddDataCollectorParametersSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.AddDataCollectorParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        dataTypes: zod_1.default.array(Network.DataTypeSchema).min(1),
        maxEncodedDataSize: exports.JsUintSchema,
...
(function (Network) {
    Network.AddDataCollectorResultSchema = zod_1.default.lazy(() => zod_1.default.object({
...
(function (Network) {
    Network.DisownDataSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('network.disownData'),
        params: Network.DisownDataParametersSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.DisownDataParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
...
(function (Network) {
    Network.GetDataSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('network.getData'),
        params: Network.GetDataParametersSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.GetDataParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        dataType: Network.DataTypeSchema,
        collector: Network.CollectorSchema.optional(),
        disown: zod_1.default.boolean().default(false).optional(),
        request: Network.RequestSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.GetDataResultSchema = zod_1.default.lazy(() => zod_1.default.object({
...
(function (Network) {
    Network.RemoveDataCollectorSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('network.removeDataCollector'),
        params: Network.RemoveDataCollectorParametersSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.RemoveDataCollectorParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        collector: Network.CollectorSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
...
(function (Network) {
    Network.SetExtraHeadersSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('network.setExtraHeaders'),
        params: Network.SetExtraHeadersParametersSchema,
    }));
})(Network || (exports.Network = Network = {}));
(function (Network) {
    Network.SetExtraHeadersParametersSchema = zod_1.default.lazy(() => zod_1.default.object({
        headers: zod_1.default.array(Network.HeaderSchema).min(1),
        contexts: zod_1.default
            .array(BrowsingContext.BrowsingContextSchema)
            .min(1)
            .optional(),
...
(function (Script) {
    Script.RegExpRemoteValueSchema = zod_1.default.lazy(() => Script.RegExpLocalValueSchema.and(zod_1.default.object({
        handle: Script.HandleSchema.optional(),
        internalId: Script.InternalIdSchema.optional(),
    })));
})(Script || (exports.Script = Script = {}));
(function (Script) {
    Script.DateRemoteValueSchema = zod_1.default.lazy(() => Script.DateLocalValueSchema.and(zod_1.default.object({
        handle: Script.HandleSchema.optional(),
        internalId: Script.InternalIdSchema.optional(),
    })));
})(Script || (exports.Script = Script = {}));
...
exports.InputEventSchema = zod_1.default.lazy(() => Input.FileDialogOpenedSchema);
var Input;
(function (Input) {
...
(function (Input) {
    Input.FileDialogOpenedSchema = zod_1.default.lazy(() => zod_1.default.object({
        method: zod_1.default.literal('input.fileDialogOpened'),
        params: Input.FileDialogInfoSchema,
    }));
})(Input || (exports.Input = Input = {}));
(function (Input) {
    Input.FileDialogInfoSchema = zod_1.default.lazy(() => zod_1.default.object({
        context: BrowsingContext.BrowsingContextSchema,
        element: Script.SharedReferenceSchema.optional(),
        multiple: zod_1.default.boolean(),
    }));
})(Input || (exports.Input = Input = {}));
